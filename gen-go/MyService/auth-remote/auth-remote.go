...
func Usage() {
  ...
  fmt.Fprintln(os.Stderr, "  LoginResponse Login(LoginRequest request)")
  fmt.Fprintln(os.Stderr)
  os.Exit(0)
}
...
func main() {
  ...
  client := MyService.NewAuthClient(thrift.NewTStandardClient(iprot, oprot))
  ...
  case "Login":
    ...
    argvalue0 := MyService.NewLoginRequest()
